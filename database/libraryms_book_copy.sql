...
CREATE TABLE `book_copy` (
  ...
  `qr_code_str` varchar(100) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `qr_code_str` (`qr_code_str`),
  KEY `book_id` (`book_id`),
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_book_copy_insert` AFTER INSERT ON `book_copy` FOR EACH ROW BEGIN
    UPDATE book
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_book_copy_update` AFTER UPDATE ON `book_copy` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_book_copy_delete` AFTER DELETE ON `book_copy` FOR EACH ROW BEGIN
    UPDATE book
    SET total_copies = total_copies - 1,
